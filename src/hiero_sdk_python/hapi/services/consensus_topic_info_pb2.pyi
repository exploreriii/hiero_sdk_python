...
class ConsensusTopicInfo(_message.Message):
    __slots__ = ("memo", "runningHash", "sequenceNumber", "expirationTime", "adminKey", "submitKey", "autoRenewPeriod", "autoRenewAccount", "ledger_id", "fee_schedule_key", "fee_exempt_key_list", "custom_fees")
